          ...
          return (
            ...
            >
              ...
              {item.href === "/dashboard/testimonials" && pendingCount > 0 && (
                <span className="ml-auto bg-indigo-700 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
      ...
      <div className="p-4 border-t border-gray-100">
        {profile?.plan === "free" && (
          <Link
            ...
            onClick={() => setMobileOpen(false)}
            className="block mb-3 p-3 bg-indigo-50 rounded-lg text-xs text-indigo-800 font-medium hover:bg-indigo-100 transition-colors"
          >
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-14 bg-white border-b border-gray-100 flex items-center justify-between px-4 z-30">
        ...
        >
          ...
          {pendingCount > 0 && (
            <span className="absolute top-1 right-1 w-2 h-2 bg-indigo-700 rounded-full" />
          )}
        </button>
      </div>
