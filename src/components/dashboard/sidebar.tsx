          ...
          return (
            ...
            >
              ...
              {item.href === "/dashboard/testimonials" && pendingCount > 0 && (
                <span className="ml-auto bg-violet-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
      ...
      <div className="p-4 border-t border-gray-100">
        {profile?.plan === "free" && (
          <Link
            ...
            onClick={() => setMobileOpen(false)}
            className="block mb-3 p-3 bg-violet-50 rounded-lg text-xs text-violet-700 font-medium hover:bg-violet-100 transition-colors"
          >
